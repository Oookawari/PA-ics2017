...
opcode_entry opcode_table [512] = {
  ...
  /* 0x70 */	IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2),
  /* 0x74 */	IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2),
  /* 0x78 */	IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2),
  /* 0x7c */	IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2), IDEXW(J, jcc, 2),
  ...
  /* 0x90 */	IDEX(r, xchg), IDEX(r, xchg), IDEX(r, xchg), IDEX(r, xchg),
